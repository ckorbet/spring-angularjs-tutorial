...
<div ng-app="myApp" ng-controller="myCtrl" class="table">
  <table>
  <tr><th>First Name: </th><td><input type="text" ng-model="firstname"></td></tr>
  <tr><th>Last Name: </th><td><input type="text" ng-model="lastname"></td></tr>
  </table>
  <button ng-click="myBtnClickEvent()">Click me!</button>
  </br></br>
